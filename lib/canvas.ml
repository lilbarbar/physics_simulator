...
(** Exercise 03a:
    ...
    This module is a simple record that represents the parameters of the board. It is a
    ...
    The [Position.t] is a record that contains two fields. Take a look at the signature in
